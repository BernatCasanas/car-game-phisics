...
struct VehicleInfo
{
	...
	vec3 chassis_up_size;
	vec3 chassis_up_offset;

	vec3 front_left_size;
	vec3 front_left_offset;

	vec3 front_right_size;
	vec3 front_right_offset;
	float mass;
